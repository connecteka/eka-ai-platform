...
* [x] CREATED → SYMPTOM\_ENTRY → ESTIMATE\_GENERATED → CUSTOMER\_APPROVAL
* [x] WORK\_IN\_PROGRESS → PDI\_CHECKLIST → INVOICE\_GENERATED → CLOSED
* [x] State transitions logged in `job_card_states` table
* [x] Audit trail maintained

### ✅ MG (Minimum Guarantee) Model

* [x] Calculation logic: MAX(assured\_km, actual\_km)
...
* [x] All tables created: workshops, user\_profiles, vehicles, job\_cards
* [x] MG tables: mg\_contracts, mg\_vehicle\_logs, mg\_calculation\_logs
* [x] Invoice tables: invoices, invoice\_items, credit\_debit\_notes
* [x] Audit table: audit\_logs
...
* [x] Indexes on workshop\_id, status, created\_at
...
* [ ] Test job card creation → customer approval (digital signature) → invoice
...
* [ ] Review audit\_logs table daily
* [ ] Monitor intelligence\_logs for AI governance
