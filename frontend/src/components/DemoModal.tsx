...
const FEATURE_DEMOS: Record<string, FeatureDemo> = {
  pdi: {
    ...
    steps: [
      { title: 'Create New PDI', description: 'Click "New Inspection" to start a fresh PDI checklist', action: 'Click', highlight: 'New Inspection', hotspot: { x: 85, y: 8, label: 'Click Here' } },
      { title: 'Vehicle Details', description: 'Enter registration number - system auto-fetches vehicle data', action: 'Type', highlight: 'MH01AB1234', hotspot: { x: 50, y: 30, label: 'Enter Registration' } },
  ...
  jobcard: {
    ...
    hasRealRecording: false,
    steps: [
      { title: 'Create Job Card', description: 'Customer arrives - create new job card instantly', action: 'Click', highlight: '+ New Job', hotspot: { x: 88, y: 5, label: 'New Job Card' } },
